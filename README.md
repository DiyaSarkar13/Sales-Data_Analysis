...
The dashboard provides comprehensive business insights across products, regions, promotions, and time periods, enabling data-driven decision-making.
...
4. Period comparison:
   - Compare Sales, Profit, and Quantity between any two user-selected time ranges.

5. Average discount analysis by promotion category.

6. Total number of orders.

7. Detailed order-level view including:
   - Sales
   - Net Sales
   - Profit
   - Discount
   - Units Sold  
   (Fully filterable by Product, Date, Customer ID, and Promotion Category)

8. Geographic sales distribution by city.
...
- DAX (Business KPIs & Dynamic Measures)
- Excel Dataset
...
- Profitability strongly correlates with controlled discount strategies.
- Regional diversification could improve overall revenue stability.
...
- Cohort analysis for repeat purchase behavior
